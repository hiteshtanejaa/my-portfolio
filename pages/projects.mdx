...
## Academic Research
<Image
  src="/images/projects/msc-project.png"
  alt="t-SNE plot of the Titanic dataset showing distinct clusters"
  width={1000}
  height={300}
  priority
  className="next-image"
/>
Cluster Interpretation Via Dimenisonality Reduction
...
[Project Page ↗](/msc-project.html)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[GitHub ↗](https://github.com/hiteshtanejaa/MSc-Project/tree/main)

***

## Netflix Case Study
<Image
  src="/images/projects/netflix.jpg"
  alt="Photo"
  width={1000}
  height={400}
  priority
...
## Aerofit Case Study
<Image
  src="/images/projects/aerofit.jpg"
  alt="Photo"
  width={1000}
  height={400}
  priority
...
<Image
  src="/images/projects/profit-dashboard.png"
  alt="Photo"
  width={700}
  height={400}
  priority
